...
def pickdifficulty():
    ...
    while True:
        ...
        easy_width, easy_height = font.size("easy")
        easy_x = 105
        easy_y = 150

        hard_width, hard_height = font.size("hard")
        hard_x = 200
        hard_y = 150
